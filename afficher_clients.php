...
<ul>
       <?php foreach ($resultat as $resultat):  ?>
			<li>
			<?= $resulat['id'] ?>-<?= $resulat['nom'] ?>-<?= $resulat['prenom'] ?>-<?= $resulat['telephone'] ?>-<?= $resulat['email'] ?>-<?= $resulat['adresse'] ?>
	        </li>
	   <?php endforeach; ?>
</ul>
<tr><td width="160"><a href="afficher_clients.php"> afficher clients</a></td></tr>
